...
$Lineage = [ordered]@{
    ...
    nativeQaRounds = 2
    wackRounds = 2
    approvedWackFileVersion = $Canonical.approvedWackFileVersion
    approvedWackSha256 = $Canonical.approvedWackSha256
    approvedWackSignerSubject = $Canonical.approvedWackSignerSubject
    approvedWackSignerThumbprint = $Canonical.approvedWackSignerThumbprint
    approvedWackTestCount = [int]$Canonical.approvedWackTestCount
    approvedWackTestInventorySha256 = $Canonical.approvedWackTestInventorySha256
